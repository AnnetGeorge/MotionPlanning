...
class DStar:
    ...
    def visualisation(self, rob_traj, obs_traj, rob_step, obs_step, rob_idx, c1_prev, c2_prev, itr, time_step=0.5):
        # vel = steps/time_step
        ...
        return rob_idx, c1_prev, c2_prev
